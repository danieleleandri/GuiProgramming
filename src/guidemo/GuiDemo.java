...
//				+ "And little bugs have littler bugs,\n" + "      And so it goes, ad infinitum.");
		drawPanel.getTextItem().setText("La gatta frettolosa fece i gattini ciechi\n" + "(Hurried cat made blind kittens)\n"
				+ "-old italian saying-");
...
//						"<html>Use a solid color for background<br>instead of an image.</html>");
				putValue(Action.SMALL_ICON,	Util.iconFromResource("resources/icons/color.png"));
			} else if (text.equals("Custom...")) {
				putValue(Action.SMALL_ICON,	Util.iconFromResource("resources/icons/custom.png"));
